    ...
    <>
      ...
      <div className="container-fluid bg-primary hero-header mb-5">
        <div className="container text-center">
          <h1 className="display-4 text-white mb-3">Bailes Tropicales</h1>
        ...
        <div className="container py-5">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6" data-wow-delay="0.1s">
              <img
                className="img-fluid"
                src="assets/assets/img/tango-imagen-silueta.png"
              />
            </div>
      ...
      <div className="container-fluid py-5 ">
        <div className="container ">
          ...
          <div className="row g-4">
            <div className="col-12 col-md-4 col-lg-3" data-wow-delay="0.1s">
            ...
            <div className="col-12 col-md-4 col-lg-3" data-wow-delay="0.3s">
              <div className="product-item text-center border h-100 p-4">
                <img
                  className="img-fluid mb-4"
            ...
            <div className="col-12 col-md-4 col-lg-3" data-wow-delay="0.5s">
              <div className="product-item text-center border h-100 p-4">
                <img
                  className="img-fluid mb-4"
            ...
            <div className="col-12 col-md-4 col-lg-3" data-wow-delay="0.7s">
              <div className="product-item text-center border h-100 p-4">
                <img
                  className="img-fluid mb-4"
            ...
            <div className="col-12 col-md-4 col-lg-3" data-wow-delay="0.7s">
              <div className="product-item text-center border h-100 p-4">
                <img
                  className="img-fluid mb-4"
                  src="assets/img/bachata-image.png"
                  alt=""
                />
                <div className="mb-2">
                  <small className="fa fa-star text-primary" />
...
export default Bailes_Tropicales;
